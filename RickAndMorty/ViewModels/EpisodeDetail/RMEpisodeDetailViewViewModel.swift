    ...
    private func createCellViewModels() {
        ...
        cellViewModels = [
            .information(viewModel: [
                .init(tittle: "Episode Name", value: episode.name),
                .init(tittle: "Air Date", value: episode.air_date),
                .init(tittle: "Episode", value: episode.episode),
                .init(tittle: "Created", value: episode.created)
            ]),
